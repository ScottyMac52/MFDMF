...
namespace MFDMFApp.Extensions
{
    ...
    public static class ImageHandlerExtensions
    {
        ...
        /// <param name="bitmapImage"></param>
        /// <param name="fileName"></param>
        public static void SaveToJpg(this BitmapSource bitmapImage, string fileName)
        {
        ...
        public static BitmapSource ToTransparentPng(this BitmapSource sourceBitmap, System.Drawing.Color transparentColor)
        {
            ...
            FormatConvertedBitmap fcb = new FormatConvertedBitmap(sourceBitmap, sourceBitmap?.Format ?? PixelFormats.Default, null, 0);
            ...
            byte TransparentByte = byte.Parse("0", null);
            byte Byte255 = byte.Parse("255", null);
